...
ocabas: game.o command.o space.o game_loop.o graphic_engine.o screen.o game_reader.o player.o object.o
	gcc -ansi -pedantic -Wall -o ocabas command.o space.o game_loop.o game.o graphic_engine.o screen.o game_reader.o player.o object.o
