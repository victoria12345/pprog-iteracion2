...
*Esta estructura define una casilla que consta de un nombre y un Id que la identifican, además de tener un 4 Ids que indican con que otras casillas está conectada a través de los 4 puntos cardinales y un entero que indica el id del objeto que se encuentra en esa casilla. 
*/
...
/**
*@brief establece o cambia el objeto que se encuentra en una casilla.
*@param space casilla en la que queremos cambiar el objeto.
*@param id_object objeto que queremos añadir a una casilla.
